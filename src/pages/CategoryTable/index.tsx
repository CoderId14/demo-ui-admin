...
function convertToDataTable(data: Category[]) {
  ...
  data.map((category) => {
    let tempData: DataType = {
      ...
      modifiedDate: format(new Date(category.modifiedDate), 'yyyy/MM/dd kk:mm:ss'),
    }
...
const CategoryTable: React.FC = () => {
  ...
  return (
    <>
      <Row>
        <Button type='primary' onClick={() =>navigate(AppConst.CATEGORY_ADMIN_ADD_URL)}>Add New Category</Button>
      </Row>
      <Table
        columns={columns}
